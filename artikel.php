...
<div class="row">
    <div class="col-sm-8">
        <div class="thumbnail">
            ...
            <img src="admin/artikel/gambar/<?php echo $data['gambar'];?>" width="100%" alt="Cinque Terre"><br>


            <div class="caption">
                <div class="text-justify" style="font-size: 18px;"><br>
                <?php
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <img src="gambar/user.jpg" width="100%" alt="Cinque Terre">
                            </div>
                            <div class="col-sm-11">
    ...
    <div class="col-sm-4">
        <div class="row">
            <?php
                include 'config/database.php';
                $sql="select * from artikel where id_kategori=16 order by id_artikel desc";
                $hasil=mysqli_query($kon,$sql);
            ...
            <div class="col-sm-12">
                <div class="caption">
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <img src="admin/artikel/gambar/<?php echo $data['gambar'];?>" width="100%" alt="wisata">
                        </div>
                        <div class="col-sm-9">
                            <?php
